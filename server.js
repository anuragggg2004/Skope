...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", "https://cdnjs.cloudflare.com", "https://www.google.com", "https://www.gstatic.com", "https://apis.google.com", "https://accounts.google.com"],
...
app.post('/api/auth/forgot-password', authLimiter, async (req, res, next) => {
  try {
    ...
    // Build reset URL dynamically from request headers prioritizing active visiting host
    const protocol = req.headers['x-forwarded-proto'] || req.protocol
    const host = req.headers['x-forwarded-host'] || req.headers.host
    const dynamicAppUrl = `${protocol}://${host}`
    const appUrl = dynamicAppUrl || process.env.APP_URL
